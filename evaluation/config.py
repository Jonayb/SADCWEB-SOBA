...
tf.app.flags.DEFINE_float('learning_rate', 0.01, 'learning rate')  # 0.07
tf.app.flags.DEFINE_integer('n_class', 3, 'number of distinct class')
tf.app.flags.DEFINE_integer('max_sentence_len', 80, 'max number of tokens per sentence')
tf.app.flags.DEFINE_integer('max_doc_len', 20, 'max number of tokens per sentence')
tf.app.flags.DEFINE_float('l2_reg', 0.0001, 'l2 regularization')  # 0.00001
...
tf.app.flags.DEFINE_float('keep_prob1', 0.4, 'dropout keep prob')  # 0.5
...
tf.app.flags.DEFINE_float('momentum', 0.9, 'momentum rate')  # 0.85
